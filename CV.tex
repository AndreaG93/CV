...
{\scriptsize 	\begin{tabular}{lcc|c}
		...
		\\
		{\texttt{C}} & $\FullBlock\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 2 & 2020 \\[5pt]
		{\texttt{C++}} & $\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 0.5 & 2012 \\[5pt]
		{\texttt{C\#}} & $\FullBlock\FullBlock\FullBlock\FullBlock\EmptyBlock\EmptyBlock$ & 1.5 & 2023 \\[5pt]
		{\texttt{Java}} & $\FullBlock\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 2 & 2020 \\[5pt]
		{\texttt{Go}} & $\FullBlock\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 1.5 & 2022 \\[5pt]
		{\texttt{Python}} & $\FullBlock\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 1.5 & 2021 \\[5pt]
		{\texttt{Assembly}} & \multirow{2}{*}{$\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock$} & \multirow{2}{*}{0.5} & \multirow{2}{*}{2015} \\
		{\texttt{MIPS}} & & \\[5pt]
		{\texttt{Assembly}} & \multirow{2}{*}{$\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock$} & \multirow{2}{*}{0.5} & \multirow{2}{*}{2020} \\
		{\texttt{x86}} & & \\[5pt]
		{\texttt{HTML}} & $\FullBlock\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 2 & 2023 \\[5pt]
		{\texttt{CSS}} & $\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 0.5 & 2023 \\[5pt]
		\texttt{JSON} & $\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 2 & 2023 \\[5pt]
		\LaTeX & $\FullBlock\FullBlock\FullBlock\EmptyBlock\EmptyBlock\EmptyBlock$ & 4 & 2023 \\\\\\
	
	\end{tabular}}

\CvSidebarSection{\faStar}{Soft Skill}


\skills{Problem-solving/5} \\	
\vspace*{0.1cm}	
\skills{Teamwork/3} \\
\vspace*{0.1cm}		
\skills{Time management/4} \\
\vspace*{0.1cm}		
...
\begin{tabular}{p{\ComputerSkillGroupColumn}p{\ComputerSkillColumn}}
	\TableHeader{Databases} & Microsoft SQL Server \MediumLevel \Sep PostgreSQL \MediumLevel \Sep InfluxDB \BasicLevel \Sep Apache Cassandra \BasicLevel \Sep Apache Kakfa \BasicLevel \\\\
\end{tabular}
